...
### SEE ALSO
* [foobar](foobar.md)	 - 
* [foobar deploy amazon](foobar_deploy_amazon.md)	 - Deploy a Pachyderm cluster running on AWS.
* [foobar deploy azure](foobar_deploy_azure.md)	 - Deploy a Pachyderm cluster running on Microsoft Azure.
* [foobar deploy custom](foobar_deploy_custom.md)	 - Deploy a custom Pachyderm cluster configuration
* [foobar deploy export-images](foobar_deploy_export-images.md)	 - Export a tarball (to stdout) containing all of the images in a deployment.
* [foobar deploy google](foobar_deploy_google.md)	 - Deploy a Pachyderm cluster running on Google Cloud Platform.
* [foobar deploy import-images](foobar_deploy_import-images.md)	 - Import a tarball (from stdin) containing all of the images in a deployment and push them to a private registry.
* [foobar deploy list-images](foobar_deploy_list-images.md)	 - Output the list of images in a deployment.
* [foobar deploy local](foobar_deploy_local.md)	 - Deploy a single-node Pachyderm cluster with local metadata storage.
* [foobar deploy microsoft](foobar_deploy_microsoft.md)	 - Deploy a Pachyderm cluster running on Microsoft Azure.
* [foobar deploy storage](foobar_deploy_storage.md)	 - Deploy credentials for a particular storage provider.
