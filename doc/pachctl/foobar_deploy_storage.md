...
* [foobar deploy storage amazon](foobar_deploy_storage_amazon.md)	 - Deploy credentials for the Amazon S3 storage provider.
* [foobar deploy storage aws](foobar_deploy_storage_aws.md)	 - Deploy credentials for the Amazon S3 storage provider.
* [foobar deploy storage azure](foobar_deploy_storage_azure.md)	 - Deploy credentials for the Azure storage provider.
* [foobar deploy storage google](foobar_deploy_storage_google.md)	 - Deploy credentials for the Google Cloud storage provider.
* [foobar deploy storage microsoft](foobar_deploy_storage_microsoft.md)	 - Deploy credentials for the Azure storage provider.
